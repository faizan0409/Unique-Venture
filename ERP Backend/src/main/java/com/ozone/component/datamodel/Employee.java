...
public class Employee extends BaseModel {
	...
	public String toString() {
		return "Employee [employeeId=" + employeeId + ", imageData=" + imageData + ", imageContentType="
				+ imageContentType + ", fullName=" + fullName + ", personalEmailId=" + personalEmailId
				+ ", organizationEmailId=" + organizationEmailId + ", contactNumber=" + contactNumber + ", password="
				+ password + ", address=" + address + ", pincode=" + pincode + ", state=" + state + ", city=" + city
				+ ", country=" + country + ", contractBased=" + contractBased + ", dateOfBirth=" + dateOfBirth
				+ ", gender=" + gender + ", highestQualification=" + highestQualification + ", bloodGroup=" + bloodGroup
				+ ", emergencyContactNo=" + emergencyContactNo + ", joiningDate=" + joiningDate + ", experienceInMonth="
				+ experienceInMonth + ", skillSet=" + skillSet + ", departmentId=" + departmentId + ", roleId=" + roleId
				+ ", pfAccount=" + pfAccount + ", medicalStatus=" + medicalStatus + "]";
	}
